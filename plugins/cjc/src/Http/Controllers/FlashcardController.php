...
class FlashcardController extends Controller
{
    ...
    public function updateDeck(Request $request, string $deck): JsonResponse
    {
        ...
        $data['updated_at'] = now();
        DB::table('cjc_flashcard_decks')->where('tenant_id', $tenantId)->where('id', $deck)->update($data);
    ...
    public function destroyDeck(Request $request, string $deck): JsonResponse
    {
        ...
        DB::transaction(function () use ($tenantId, $ids): void {
            DB::table('cjc_flashcards')->where('tenant_id', $tenantId)->whereIn('deck_id', $ids)
                ->update(['is_active' => false, 'updated_at' => now()]);
            DB::table('cjc_flashcard_decks')->where('tenant_id', $tenantId)->whereIn('id', $ids)
                ->update(['is_active' => false, 'updated_at' => now()]);
            DB::table('cjc_content_targets')->where('tenant_id', $tenantId)
    ...
    public function updateCard(Request $request, string $card): JsonResponse
    {
        ...
        DB::table('cjc_flashcards')->where('tenant_id', $tenantId)->where('id', $card)->update($update);
    ...
    public function destroyCard(Request $request, string $card): JsonResponse
    {
        ...
        DB::table('cjc_flashcards')->where('tenant_id', $tenantId)->where('id', $card)
            ->update(['is_active' => false, 'updated_at' => now()]);
    ...
    public function updateStudentDeck(Request $request, int $tenant, string $deck): JsonResponse
    {
        ...
        DB::table('cjc_flashcard_decks')->where('tenant_id', $tenant)->where('id', $deck)->update($data);
    ...
    public function destroyStudentDeck(Request $request, int $tenant, string $deck): JsonResponse
    {
        ...
        DB::transaction(function () use ($tenant, $ids): void {
            DB::table('cjc_flashcards')->where('tenant_id', $tenant)->whereIn('deck_id', $ids)
                ->update(['is_active' => false, 'updated_at' => now()]);
            DB::table('cjc_flashcard_decks')->where('tenant_id', $tenant)->whereIn('id', $ids)
                ->update(['is_active' => false, 'updated_at' => now()]);
        });
    ...
    public function updateStudentCard(Request $request, int $tenant, string $card): JsonResponse
    {
        ...
        $update = $this->cardUpdatePayload($data);
        $update['updated_at'] = now();
        DB::table('cjc_flashcards')->where('tenant_id', $tenant)->where('id', $row->id)->update($update);
    ...
    public function destroyStudentCard(Request $request, int $tenant, string $card): JsonResponse
    {
        ...
        DB::table('cjc_flashcards')->where('tenant_id', $tenant)->where('id', $card)
            ->update(['is_active' => false, 'updated_at' => now()]);
    ...
    public function reviewStudentCard(Request $request, int $tenant, string $card): JsonResponse
    {
        ...
        if ($contestId && ! DB::table('cjc_student_contests')
        ...
        $last = DB::table('cjc_flashcard_reviews')
    ...
    public function pendingStudentCards(Request $request, int $tenant): JsonResponse
    {
        ...
        $latest = DB::table('cjc_flashcard_reviews')
            ->where('tenant_id', $tenant)
            ->where('student_id', $student->id)
    ...
    public function studentHistory(Request $request, int $tenant): JsonResponse
    {
        ...
        $history = DB::table('cjc_flashcard_reviews as r')
            ->join('cjc_flashcards as c', 'c.id', '=', 'r.card_id')
            ->join('cjc_flashcard_decks as d', 'd.id', '=', 'c.deck_id')
    ...
    {
        $map = [
            'contest_id' => 'cjc_contests',
            'edict_id' => 'cjc_edicts',
            'parent_deck_id' => 'cjc_flashcard_decks',
            'subject_id' => 'cjc_subjects',
            'topic_id' => 'cjc_topics',
            'subtopic_id' => 'cjc_subtopics',
        ];
    ...
    {
        foreach (['topic_id' => 'cjc_topics', 'subtopic_id' => 'cjc_subtopics'] as $field => $table) {
    ...
    {
        $row = DB::table('cjc_flashcard_decks')
    ...
    private function studentVisibleCards($student, int $tenantId)
    {
        ...
        $ownDeckIds = DB::table('cjc_flashcard_decks')
            ->where('tenant_id', $tenantId)
            ->where('owner_type', 'aluno')
            ->where('student_id', $student->id)
            ->where('is_active', true)
        ...
        return DB::table('cjc_flashcards as c')
            ->join('cjc_flashcard_decks as d', 'd.id', '=', 'c.deck_id')
            ->where('c.tenant_id', $tenantId)
    ...
    private function descendantDeckIds(int $tenantId, string $deckId): array
    {
        ...
        while ($queue !== []) {
            ...
            $children = DB::table('cjc_flashcard_decks')
                ->where('tenant_id', $tenantId)
