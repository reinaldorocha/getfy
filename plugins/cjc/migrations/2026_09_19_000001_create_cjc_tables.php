...
return new class extends Migration
{
    ...
    {
        Schema::create('cjc_products', function (Blueprint $t) {
        ...
        Schema::create('cjc_audit_events', function (Blueprint $t) {
        ...
        Schema::create('cjc_contests', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
        ...
        Schema::create('cjc_student_contests', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreign('contest_id')->references('id')->on('cjc_contests')->cascadeOnDelete();
            $t->unique(['tenant_id','student_id','contest_id']);
        });

        Schema::create('cjc_edicts', function (Blueprint $t) {
        ...
        Schema::create('cjc_subjects', function (Blueprint $t) {
            ...
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('edict_id')->references('id')->on('cjc_edicts')->cascadeOnDelete();
        });

        Schema::create('cjc_topics', function (Blueprint $t) {
            ...
            $t->unsignedTinyInteger('relevance')->nullable(); $t->text('notes')->nullable(); $t->json('materials')->nullable();
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('subject_id')->references('id')->on('cjc_subjects')->cascadeOnDelete();
        });

        Schema::create('cjc_subtopics', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index(); $t->uuid('topic_id');
            $t->string('name',500); $t->unsignedInteger('position')->default(0); $t->decimal('weight',8,2)->nullable();
            $t->unsignedTinyInteger('relevance')->nullable(); $t->text('notes')->nullable(); $t->json('materials')->nullable();
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('topic_id')->references('id')->on('cjc_topics')->cascadeOnDelete();
        });

        Schema::create('cjc_student_edicts', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
        ...
        Schema::create('cjc_edict_progress', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete();
            ...
            $t->unique(['tenant_id','student_id','item_type','item_id'],'cjc_edict_progress_unique');
        });

        Schema::create('cjc_support_materials', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreignId('created_by')->constrained('users')->cascadeOnDelete();
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('edict_id')->references('id')->on('cjc_edicts')->nullOnDelete();
        });

        Schema::create('cjc_notebooks', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete();
            ...
            $t->foreign('edict_id')->references('id')->on('cjc_edicts')->nullOnDelete();
            $t->foreign('subject_id')->references('id')->on('cjc_subjects')->nullOnDelete();
            $t->foreign('topic_id')->references('id')->on('cjc_topics')->nullOnDelete();
        });

        Schema::create('cjc_question_bank', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreignId('created_by')->constrained('users')->cascadeOnDelete();
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('contest_id')->references('id')->on('cjc_contests')->nullOnDelete();
        });

        Schema::create('cjc_question_answers', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreign('question_id')->references('id')->on('cjc_question_bank')->cascadeOnDelete();
            $t->foreign('contest_id')->references('id')->on('cjc_contests')->nullOnDelete();
        });

        Schema::create('cjc_schedules', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
        ...
        Schema::create('cjc_schedule_items', function (Blueprint $t) {
            ...
            $t->foreign('schedule_id')->references('id')->on('cjc_schedules')->cascadeOnDelete();
            $t->foreign('subject_id')->references('id')->on('cjc_subjects')->nullOnDelete();
            $t->foreign('topic_id')->references('id')->on('cjc_topics')->nullOnDelete();
            $t->foreign('subtopic_id')->references('id')->on('cjc_subtopics')->nullOnDelete();
        });

        Schema::create('cjc_flashcard_decks', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreign('contest_id')->references('id')->on('cjc_contests')->nullOnDelete();
            $t->foreign('edict_id')->references('id')->on('cjc_edicts')->nullOnDelete();
            $t->foreign('parent_deck_id')->references('id')->on('cjc_flashcard_decks')->nullOnDelete();
            $t->foreign('subject_id')->references('id')->on('cjc_subjects')->nullOnDelete();
            $t->foreign('topic_id')->references('id')->on('cjc_topics')->nullOnDelete();
            $t->foreign('subtopic_id')->references('id')->on('cjc_subtopics')->nullOnDelete();
        });

        Schema::create('cjc_flashcards', function (Blueprint $t) {
            ...
            $t->foreignId('created_by')->constrained('users')->cascadeOnDelete();
            $t->boolean('is_active')->default(true); $t->timestamps();
            $t->foreign('deck_id')->references('id')->on('cjc_flashcard_decks')->cascadeOnDelete();
            $t->foreign('topic_id')->references('id')->on('cjc_topics')->nullOnDelete();
            $t->foreign('subtopic_id')->references('id')->on('cjc_subtopics')->nullOnDelete();
        });

        Schema::create('cjc_flashcard_reviews', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            ...
            $t->foreign('card_id')->references('id')->on('cjc_flashcards')->cascadeOnDelete();
            $t->foreign('contest_id')->references('id')->on('cjc_contests')->nullOnDelete();
        });

        Schema::create('cjc_study_sessions', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete();
        ...
        Schema::create('cjc_question_logs', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete();
            $t->uuid('contest_id')->nullable(); $t->uuid('subject_id')->nullable(); $t->uuid('topic_id')->nullable(); $t->uuid('subtopic_id')->nullable();
        ...
        Schema::create('cjc_scheduled_reviews', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete();
            $t->uuid('contest_id')->nullable(); $t->uuid('subject_id')->nullable(); $t->uuid('topic_id')->nullable(); $t->uuid('subtopic_id')->nullable();
        ...
        Schema::create('cjc_mock_exams', function (Blueprint $t) {
            $t->uuid('id')->primary(); $t->unsignedBigInteger('tenant_id')->index();
            $t->foreignId('student_id')->constrained('users')->cascadeOnDelete(); $t->uuid('contest_id')->nullable();
    ...
    {
        foreach ([
            'cjc_mock_exams','cjc_scheduled_reviews','cjc_question_logs','cjc_study_sessions',
            'cjc_flashcard_reviews','cjc_flashcards','cjc_flashcard_decks','cjc_schedule_items',
            'cjc_schedules','cjc_question_answers','cjc_question_bank','cjc_notebooks',
            'cjc_support_materials','cjc_edict_progress','cjc_student_edicts','cjc_subtopics',
            'cjc_topics','cjc_subjects','cjc_edicts','cjc_student_contests','cjc_contests',
            'cjc_audit_events','cjc_products'
        ] as $table) {
