...
import{n as y,p as ht,e as S,o as E,b as Qt,a6 as Oe,u as b,k as B,a7 as Ht,s as _,a8 as qt,a9 as g,aa as bt,a1 as Ut,g as Q,h as zt,ab as Be,ac as jt,ad as Yt,ae as Zt,af as X,j as q,ag as Ge,ah as Jt,r as Ne,ai as Ve,x as Fe,aj as Ee,J as yt,i as G,t as Re,C as Xt,d as te,ak as ee,al as We,a3 as gt,l as J,Z as Ke,am as Qe,an as He,ao as qe,ap as Ue,$ as se,a4 as _t}from"./vidstack-C2US-gSO-C_y7_0VX.js";import{b as ne}from"./app-CH70XmSb.js";import{A as N,T as ze,D as Vt,x as i,s as je,L as xt}from"./vidstack-CwTj4H1w-cyUztiKU.js";import"./floating-ui.dom-RhtQlTMy.js";import"./runtime-dom.esm-bundler-OrSu0e66.js";import"./Toggle-YxYYHqIG.js";const Tt=e=>e??N;const tt={ATTRIBUTE:1,CHILD:2,BOOLEAN_ATTRIBUTE:4},U=e=>(...t)=>({_$litDirective$:e,values:t});let wt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};let et=class extends wt{constructor(t){if(super(t),this.et=N,t.type!==tt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===N||t==null)return this.ft=void 0,this.et=t;if(t===ze)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const s=[t];return s.raw=s,this.ft={_$litType$:this.constructor.resultType,strings:s,values:[]}}};et.directiveName="unsafeHTML",et.resultType=1;const ae=U(et);class $t extends et{}$t.directiveName="unsafeSVG",$t.resultType=2;const Ye=U($t);const Ze=e=>e.strings===void 0,Je={},Xe=(e,t=Je)=>e._$AH=t;const H=(e,t)=>{var s,n;const a=e._$AN;if(a===void 0)return!1;for(const l of a)(n=(s=l)._$AO)===null||n===void 0||n.call(s,t,!1),H(l,t);return!0},st=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while(s?.size===0)},ie=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),ss(t)}};function ts(e){this._$AN!==void 0?(st(this),this._$AM=e,ie(this)):this._$AM=e}function es(e,t=!1,s=0){const n=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(t)if(Array.isArray(n))for(let l=s;l<n.length;l++)H(n[l],!1),st(n[l]);else n!=null&&(H(n,!1),st(n));else H(this,e)}const ss=e=>{var t,s,n,a;e.type==tt.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=es),(s=(a=e)._$AQ)!==null&&s!==void 0||(a._$AQ=ts))};class oe extends wt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),ie(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,a;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(a=this.disconnected)===null||a===void 0||a.call(this)),s&&(H(this,t),st(this))}setValue(t){if(Ze(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class ns extends oe{#t=null;#e=!1;#s=null;constructor(t){super(t),this.#e=t.type===tt.ATTRIBUTE||t.type===tt.BOOLEAN_ATTRIBUTE}render(t){return t!==this.#t&&(this.disconnected(),this.#t=t,this.isConnected&&this.#n()),this.#t?this.#a(ht(this.#t)):N}reconnected(){this.#n()}disconnected(){this.#s?.(),this.#s=null}#n(){this.#t&&(this.#s=S(this.#o.bind(this)))}#a(t){return this.#e?Tt(t):t}#i(t){this.setValue(this.#a(t))}#o(){this.#i(this.#t?.())}}function o(e){return U(ns)(y(e))}class le{#t;#e;elements=new Set;constructor(t,s){this.#t=t,this.#e=s}connect(){this.#n();const t=new MutationObserver(this.#s);for(const s of this.#t)t.observe(s,{childList:!0,subtree:!0});E(()=>t.disconnect()),E(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){Oe(t)?(s.textContent="",s.append(t)):(Vt(null,s),Vt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}#s=Qt(this.#n.bind(this));#n(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this.#t.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.#e(this.elements)}}let as=0,Z="data-slot-id";class kt{#t;slots;constructor(t){this.#t=t,this.slots=new le(t,this.#s.bind(this))}connect(){this.slots.connect(),this.#s();const t=new MutationObserver(this.#e);for(const s of this.#t)t.observe(s,{childList:!0});E(()=>t.disconnect())}#e=Qt(this.#s.bind(this));#s(){for(const t of this.#t)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(Z);a||s.setAttribute(Z,a=++as+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(Z)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(Z,a)}}}}function re({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return i`<svg
>>>>>>> main:public/build/assets/vidstack-player-layouts-CW5QWNsu.js
    class="${"vds-icon"+(t?` ${t}`:"")}"
    viewBox="${a}"
    fill="none"
    aria-hidden="true"
  ...
  `}function he(e,t,s,n){let a=B(t)?document.querySelector(t):t;a||(a=e?.closest("dialog")),a||(a=document.body);const l=document.createElement("div");l.style.display="contents",l.classList.add(s),a.append(l),S(()=>{if(!l)return;const{viewType:p}=g(),u=n();Q(l,"data-view-type",p()),Q(l,"data-sm",u),Q(l,"data-lg",!u),Q(l,"data-size",u?"sm":"lg")});const{colorScheme:r}=d();return ee(l,r),l}function be({placement:e,tooltip:t,portal:s}){const{textTracks:n}=b(),{viewType:a,seekableStart:l,seekableEnd:r}=g(),{translations:p,thumbnails:u,menuPortal:v,noModal:f,menuGroup:m,smallWhen:x}=d();if(y(()=>{const P=l(),W=r(),K=_(null);return Zt(n,"chapters",K.set),!K()?.cues.filter(Nt=>Nt.startTime<=W&&Nt.endTime>=P)?.length})())return null;const w=y(()=>f()?X(e):x()?null:X(e)),M=y(()=>!x()&&m()==="bottom"&&a()==="video"?26:0),k=_(!1);function O(){k.set(!0)}function Y(){k.set(!1)}const R=i`
    <media-menu-items
  ...
  `}function ys({value:e=null,options:t,hideLabel:s=!1,children:n=null,onChange:a=null}){function l(r){const{value:p,label:u}=r;return i`
  ...
  `}function L({label:e,option:t,type:s}){const{player:n}=b(),{translations:a}=d(),l=V[s],r=()=>C(a,e);function p(){Re(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let f=function(m){l.set(m.target.value),p()};return j({label:o(r),children:i`
        <input
  ...
  `}function Ls(){return o(()=>{const{translations:e}=d();return i`
    ...
    `})}function Os(){const{userPrefersAnnouncements:e,translations:t}=d(),s="Announcements";return j({label:c(t,s),children:ut({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function Bs(){return o(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=d(),{viewType:n}=g();if(y(()=>n()!=="video"||s())())return null;const l="Keyboard Animations";return j({label:c(e,l),children:ut({label:l,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function Gs(){return o(()=>{const{noAudioGain:e,translations:t}=d(),{audioTracks:s,canSetAudioGain:n}=g();return y(()=>!(n()&&!e())&&s().length<=1)()?null:i`
    ...
    `})}function Ns(){return o(()=>{const{translations:e}=d(),{audioTracks:t}=g(),s=c(e,"Default");return y(()=>t().length<=1)()?null:D({children:i`
      ...
      `})})}function Vs(){return o(()=>{const{noAudioGain:e,translations:t}=d(),{canSetAudioGain:s}=g();if(y(()=>!s()||e())())return null;const{audioGain:a}=g();return D({label:c(t,"Boost"),value:o(()=>Math.round(((a()??1)-1)*100)+"%"),children:[rt({upIcon:"menu-audio-boost-up",downIcon:"menu-audio-boost-down",children:Fs(),isMin:()=>((a()??1)-1)*100<=ye(),isMax:()=>((a()??1)-1)*100===ge()})]})})}function Fs(){const{translations:e}=d(),t=c(e,"Boost"),s=ye,n=ge,a=Es;return i`
  ...
  `}function ye(){const{audioGains:e}=d(),t=e();return G(t)?t[0]??0:t.min}function ge(){const{audioGains:e}=d(),t=e();return G(t)?t[t.length-1]??300:t.max}function Es(){const{audioGains:e}=d(),t=e();return G(t)?t[1]-t[0]||25:t.step}function Rs(){return o(()=>{const{translations:e}=d(),{hasCaptions:t}=g(),s=c(e,"Off");return t()?i`
  ...
  `}function Us(){const{remote:e,qualities:t}=b(),{autoQuality:s,canSetQuality:n,qualities:a}=g(),{translations:l}=d(),r="Auto";return y(()=>!n()||a().length<=1)()?null:j({label:c(l,r),children:ut({label:r,checked:s,onChange(u,v){u?e.requestAutoQuality(v):e.changeQuality(t.selectedIndex,v)}})})}function zs(){return o(()=>{const{hideQualityBitrate:e,translations:t}=d(),{canSetQuality:s,qualities:n,quality:a}=g(),l=y(()=>!s()||n().length<=1),r=y(()=>je(n()));return l()?null:D({label:c(t,"Quality"),value:o(()=>{const p=a()?.height,u=e()?null:a()?.bitrate,v=u&&u>0?`${(u/1e6).toFixed(2)} Mbps`:null,f=C(t,"Auto");return p?`${p}p${v?` (${v})`:""}`:f}),children:[rt({upIcon:"menu-quality-up",downIcon:"menu-quality-down",children:js(),isMin:()=>r()[0]===a(),isMax:()=>r().at(-1)===a()}),Us()]})})}function js(){const{translations:e}=d(),t=c(e,"Quality");return i`
    <media-quality-slider class="vds-quality-slider vds-slider" aria-label=${t}>
      ${ot()}${lt()}
    </media-quality-slider>
  `}function Te({placement:e,portal:t,tooltip:s}){return o(()=>{const{viewType:n}=g(),{translations:a,menuPortal:l,noModal:r,menuGroup:p,smallWhen:u}=d(),v=y(()=>r()?X(e):u()?null:X(e)),f=y(()=>!u()&&p()==="bottom"&&n()==="video"?26:0),m=_(!1);ms();function x(){m.set(!0)}function T(){m.set(!1)}const w=i`
      <media-menu-items
...
>>>>>>> main:public/build/assets/vidstack-player-layouts-CW5QWNsu.js
  ...
  `}function Gt(){const{menuGroup:e,smallWhen:t}=d(),s=()=>e()==="top"||t()?"bottom":"top",n=y(()=>`${s()} ${e()==="top"?"end":"center"}`),a=y(()=>`${s()} end`);return[be({tooltip:n,placement:a,portal:!0}),Te({tooltip:n,placement:a,portal:!0})]}function De(){return o(()=>{const{noGestures:e}=d();return e()?null:i`
  ...
  `}function Ln(){const{translations:e}=$(),{remote:t}=b(),s=h(e,"Restart");function n(a){se(a)&&!yt(a)||t.seek(0,a)}return i`
    <button
      type="button"
      class="plyr__control"
      data-plyr="restart"
  ...
  `}function Fn(){const e=b(),{translations:t,invertTime:s,toggleTime:n,displayDuration:a}=$(),l=_(ht(s));function r(u){!n()||a()||se(u)&&!yt(u)||l.set(v=>!v)}function p(){return o(()=>a()?Le():null)}return o(()=>{const{streamType:u}=e.$state,v=h(t,"LIVE"),f=h(t,"Current time"),m=o(()=>!a()&&l());return u()==="live"||u()==="ll-live"?i`
          <media-live-button
    ...
    <media-time
      ...
      aria-label=${t}
    ></media-time>
  `}function En(){return o(()=>{const e=b(),{translations:t,download:s}=$(),{title:n,source:a}=e.$state,l=a(),r=s(),p=jt({title:n(),src:l,download:r}),u=h(t,"Download");return B(p?.url)?i`
          <a
            class="plyr__controls__item plyr__control"
        ...
        `:null})}function Rn(){return o(()=>{const{clickToPlay:e,clickToFullscreen:t}=$();return[e()?i`
          ...
          `:null,t()?i`
            <media-gesture
              ...
              action="toggle:fullscreen"
            ></media-gesture>
          `:null]})}function Wn(){const e=b(),t=_(void 0),s=o(()=>ae(t()?.text));return S(()=>{const n=e.$state.textTrack();if(!n)return;function a(){t.set(n?.activeCues[0])}return a(),J(n,"cue-change",a)}),i`
